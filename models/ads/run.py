...
data = dict(train=D.NewmanRatner_loader(split='train', register="ADS", batch_size=16, shuffle=True),
            val=D.NewmanRatner_loader(split='val', register="ADS", batch_size=16, shuffle=False))
...
M.experiment(net, data, run_config, folder="/roaming/u1270964/platalea/experiments/ads/")
