...
data = dict(train=D.NewmanRatner_loader(split='train', register="ADS", root=root, batch_size=16, shuffle=True),
            val=D.NewmanRatner_loader(split='val', register="ADS", root=root, batch_size=16, shuffle=False))
