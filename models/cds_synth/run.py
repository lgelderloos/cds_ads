...
data = dict(train=D.NewmanRatner_loader(split='train', register="CDS_synth", root=root, batch_size=16, shuffle=True),
            val=D.NewmanRatner_loader(split='val', register="CDS_synth", root=root, batch_size=16, shuffle=False))
